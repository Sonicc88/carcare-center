...
@section('content')
    ...
    <div class="container-xxl rounded-2 pt-1 pb-3 mt-2" style="background-color: #FEFEFE;">
        <div class="alert alert-light p-1 ">
            <div class="row g-2">
                <a href="{{route('payment.wait')}}" class="col-sm-12 col-md-4 col-lg-3 col-xl-2 btn btn-warning fs-5 btn-sm mb-1 me-2">ລໍຄິວລ້າງ
                    <span class="badge bg-danger h5 pt-1 pb-1 pe-2 ps-2">{{$countw}}</span>
                </a>
                <a href="{{route('payment')}}" class="12 col-md-4 col-lg-3 col-xl-2 btn btn-info fs-5 btn-sm mb-1 me-2">ກໍາລັງລ້າງ
