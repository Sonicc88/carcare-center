...
<div class="container-xxl rounded-2 pt-1 pb-3 mt-2" style="background-color: #FEFEFE;">
    <div class="alert alert-light p-1">
        <div class="row g-2">
            <a href="{{route('payment.wait')}}" class="col-sm-12 col-md-4 col-lg-3 col-xl-2 btn btn-warning fs-5 btn-sm me-2">ລໍຄິວລ້າງ
            ...
            @foreach($order as $row)
                <tr class="align-middle fs-6">
                    ...
                    <td>
                        ...
                        <form action="{{route('payment.reciep')}}" method="post">
                            @csrf
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="text" name="re" id="re" class="form-control " value="{{$row->total}}">
